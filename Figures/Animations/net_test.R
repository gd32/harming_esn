...
g1 = graph_from_data_frame(round1_edgelist, directed = T, vertices = ndata1_r1)
...
g2 = graph_from_data_frame(round2_edgelist, directed = T, vertices = ndata1_r2)

round3_edgelist = ldata4 %>% filter(game == i, round == 3) %>% dplyr::select(id1, id2)
g3 = graph_from_data_frame(round3_edgelist, directed = T, vertices = ndata1_r3)

round4_edgelist = ldata4 %>% filter(game == i, round == 4) %>% dplyr::select(id1, id2)
g4 = graph_from_data_frame(round4_edgelist, directed = T, vertices = ndata1_r4)

round5_edgelist = ldata4 %>% filter(game == i, round == 5) %>% dplyr::select(id1, id2)
g5 = graph_from_data_frame(round5_edgelist, directed = T, vertices = ndata1_r5)

round6_edgelist = ldata4 %>% filter(game == i, round == 6) %>% dplyr::select(id1, id2)
g6 = graph_from_data_frame(round6_edgelist, directed = T, vertices = ndata1_r6)

round7_edgelist = ldata4 %>% filter(game == i, round == 7) %>% dplyr::select(id1, id2)
g7 = graph_from_data_frame(round7_edgelist, directed = T, vertices = ndata1_r7)

round8_edgelist = ldata4 %>% filter(game == i, round == 8) %>% dplyr::select(id1, id2)
g8 = graph_from_data_frame(round8_edgelist, directed = T, vertices = ndata1_r8)

round9_edgelist = ldata4 %>% filter(game == i, round == 9) %>% dplyr::select(id1, id2)
g9 = graph_from_data_frame(round9_edgelist, directed = T, vertices = ndata1_r9)

round10_edgelist = ldata4 %>% filter(game == i, round == 10) %>% dplyr::select(id1, id2)
g10 = graph_from_data_frame(round10_edgelist, directed = T, vertices = ndata1_r10)

round11_edgelist = ldata4 %>% filter(game == i, round == 11) %>% dplyr::select(id1, id2)
g11 = graph_from_data_frame(round11_edgelist, directed = T, vertices = ndata1_r11)

round12_edgelist = ldata4 %>% filter(game == i, round == 12) %>% dplyr::select(id1, id2)
g12 = graph_from_data_frame(round12_edgelist, directed = T, vertices = ndata1_r12)

round13_edgelist = ldata4 %>% filter(game == i, round == 13) %>% dplyr::select(id1, id2)
g13 = graph_from_data_frame(round13_edgelist, directed = T, vertices = ndata1_r13)

round14_edgelist = ldata4 %>% filter(game == i, round == 14) %>% dplyr::select(id1, id2)
g14 = graph_from_data_frame(round14_edgelist, directed = T, vertices = ndata1_r14)

round15_edgelist = ldata4 %>% filter(game == i, round == 15) %>% dplyr::select(id1, id2)
g15 = graph_from_data_frame(round15_edgelist, directed = T, vertices = ndata1_r15)
...
setwd("~/Documents/Projects/harming_esn/Figures/Animations")
  ...
  test_g10 = graph_from_edgelist(as.matrix(round10_edgelist))
  test_g10_2 = graph_from_data_frame(round10_edgelist, directed = F, vertices = ndata1_r10)
  plot( layout = coords)
  ndata1_r10 %>% arrange(id) 
  plot(test_g10)
  plot(test_g10)
  plot(g11, 
       layout = coords,  
