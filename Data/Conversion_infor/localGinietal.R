setwd("/Users/christophergerman/Desktop/GSR/DataCopy/JSON")
load(file="node_1aX.Rdata") 
load(file="link_1aX.Rdata") 
...
save(ldata4,file="ldata4_0217X.Rdata")
load("ldata4_0217X.Rdata") #ldata
...
save(ndata1,file="ndata1_0217X.Rdata") #This is used for the individual-level analysis. 
load("ndata1_0217X.Rdata") #ndata1 

dim(ndata1[ndata1$round==0,]) #581 individuals
dim(ndata1) #8772 individual-rounds (< 581*16 = 9296 individual-rounds for the complete cases). 
...
ndata2 = ndata1[,c("scoreA","scoreB","percentA","satisfaction","showScore","game","round","initScore","behavior","behaviorTime","payoff","cumulativePayoff","n_ties","id","superid")] #Variable pruning
...
outcome_data = ndata1[ndata1$round %in% c(0:15),c("gameID","game","scoreA","scoreB","percentA","satisfaction","behaviorTime","showScore","round","superid","payoff","cumulativePayoff","behavior","n_ties", "satisfaction", "cPayoffS")]
...
network_data = ndata1[,c("gameID","game","round","superid","behavior","payoff","cumulativePayoff", "satisfaction","cPayoffS","behaviorTime","superid2.1","superid2.2","superid2.3","superid2.4","superid2.5","superid2.6","superid2.7","superid2.8","superid2.9","superid2.10","superid2.11","superid2.12","superid2.13","superid2.14")]
names(network_data)[3] = "previousround"
names(network_data)[5] = "e_behavior"
names(network_data)[6] = "e_payoff"
names(network_data)[7] = "e_cumulativePayoff"
names(network_data)[8] = "e_satisfaction"
names(network_data)[9] = "e_stdPayoff"
names(network_data)[10] = "e_behaviorTime"


#Proc C: Preparing for the alter's attribute data
alter_data = ndata1[,c("gameID","game","round","superid","satisfaction","behavior","payoff","cumulativePayoff" ,"cPayoffS")]
names(alter_data) = c("gameID","game","previousround","a_superid","a_satisfaction","a_behavior","a_payoff","a_cumulativePayoff","a_cPayoffS")

#and for current round
alter_data2 = ndata1[,c("gameID","game","round","superid","satisfaction","behavior","payoff","cumulativePayoff", "cPayoffS")]
names(alter_data2) = c("gameID","game","currentround","c_superid","c_satisfaction","c_behavior","c_payoff","c_cumulativePayoff","c_cPayoffS")
...
names(a1_data) = c("gameID","game","previousround","a1_superid","a1_satisfaction","a1_behavior","a1_payoff","a1_cumulativePayoff", "a1_cPayoffS")
names(a2_data) = c("gameID","game","previousround","a2_superid","a2_satisfaction","a2_behavior","a2_payoff","a2_cumulativePayoff", "a2_cPayoffS")
names(a3_data) = c("gameID","game","previousround","a3_superid","a3_satisfaction","a3_behavior","a3_payoff","a3_cumulativePayoff", "a3_cPayoffS")
names(a4_data) = c("gameID","game","previousround","a4_superid","a4_satisfaction","a4_behavior","a4_payoff","a4_cumulativePayoff", "a4_cPayoffS")
names(a5_data) = c("gameID","game","previousround","a5_superid","a5_satisfaction","a5_behavior","a5_payoff","a5_cumulativePayoff", "a5_cPayoffS")
names(a6_data) = c("gameID","game","previousround","a6_superid","a6_satisfaction","a6_behavior","a6_payoff","a6_cumulativePayoff", "a6_cPayoffS")
names(a7_data) = c("gameID","game","previousround","a7_superid","a7_satisfaction","a7_behavior","a7_payoff","a7_cumulativePayoff", "a7_cPayoffS")
names(a8_data) = c("gameID","game","previousround","a8_superid","a8_satisfaction","a8_behavior","a8_payoff","a8_cumulativePayoff", "a8_cPayoffS")
names(a9_data) = c("gameID","game","previousround","a9_superid","a9_satisfaction","a9_behavior","a9_payoff","a9_cumulativePayoff", "a9_cPayoffS")
names(a10_data) = c("gameID","game","previousround","a10_superid","a10_satisfaction","a10_behavior","a10_payoff","a10_cumulativePayoff", "a10_cPayoffS")
names(a11_data) = c("gameID","game","previousround","a11_superid","a11_satisfaction","a11_behavior","a11_payoff","a11_cumulativePayoff", "a11_cPayoffS")
names(a12_data) = c("gameID","game","previousround","a12_superid","a12_satisfaction","a12_behavior","a12_payoff","a12_cumulativePayoff", "a12_cPayoffS")
names(a13_data) = c("gameID","game","previousround","a13_superid","a13_satisfaction","a13_behavior","a13_payoff","a13_cumulativePayoff", "a13_cPayoffS")
names(a14_data) = c("gameID","game","previousround","a14_superid","a14_satisfaction","a14_behavior","a14_payoff","a14_cumulativePayoff", "a14_cPayoffS")
names(a15_data) = c("gameID","game","previousround","a15_superid","a15_satisfaction","a15_behavior","a15_payoff","a15_cumulativePayoff", "a15_cPayoffS")
names(a16_data) = c("gameID","game","previousround","a16_superid","a16_satisfaction","a16_behavior","a16_payoff","a16_cumulativePayoff", "a16_cPayoffS")
names(a17_data) = c("gameID","game","previousround","a17_superid","a17_satisfaction","a17_behavior","a17_payoff","a17_cumulativePayoff", "a17_cPayoffS")
names(a18_data) = c("gameID","game","previousround","a18_superid","a18_satisfaction","a18_behavior","a18_payoff","a18_cumulativePayoff", "a18_cPayoffS")
names(a19_data) = c("gameID","game","previousround","a19_superid","a19_satisfaction","a19_behavior","a19_payoff","a19_cumulativePayoff", "a19_cPayoffS")
names(a20_data) = c("gameID","game","previousround","a20_superid","a20_satisfaction","a20_behavior","a20_payoff","a20_cumulativePayoff", "a20_cPayoffS")
...
names(c1_data) = c("gameID","game","currentround","c1_superid","c1_satisfaction","c1_behavior","c1_payoff","c1_cumulativePayoff", "c1_cPayoffS")
names(c2_data) = c("gameID","game","currentround","c2_superid","c2_satisfaction","c2_behavior","c2_payoff","c2_cumulativePayoff", "c2_cPayoffS")
names(c3_data) = c("gameID","game","currentround","c3_superid","c3_satisfaction","c3_behavior","c3_payoff","c3_cumulativePayoff", "c3_cPayoffS")
names(c4_data) = c("gameID","game","currentround","c4_superid","c4_satisfaction","c4_behavior","c4_payoff","c4_cumulativePayoff", "c4_cPayoffS")
names(c5_data) = c("gameID","game","currentround","c5_superid","c5_satisfaction","c5_behavior","c5_payoff","c5_cumulativePayoff", "c5_cPayoffS")
names(c6_data) = c("gameID","game","currentround","c6_superid","c6_satisfaction","c6_behavior","c6_payoff","c6_cumulativePayoff", "c6_cPayoffS")
names(c7_data) = c("gameID","game","currentround","c7_superid","c7_satisfaction","c7_behavior","c7_payoff","c7_cumulativePayoff", "c7_cPayoffS")
names(c8_data) = c("gameID","game","currentround","c8_superid","c8_satisfaction","c8_behavior","c8_payoff","c8_cumulativePayoff", "c8_cPayoffS")
names(c9_data) = c("gameID","game","currentround","c9_superid","c9_satisfaction","c9_behavior","c9_payoff","c9_cumulativePayoff", "c9_cPayoffS")
names(c10_data) = c("gameID","game","currentround","c10_superid","c10_satisfaction","c10_behavior","c10_payoff","c10_cumulativePayoff", "c10_cPayoffS")
names(c11_data) = c("gameID","game","currentround","c11_superid","c11_satisfaction","c11_behavior","c11_payoff","c11_cumulativePayoff", "c11_cPayoffS")
names(c12_data) = c("gameID","game","currentround","c12_superid","c12_satisfaction","c12_behavior","c12_payoff","c12_cumulativePayoff", "c12_cPayoffS")
names(c13_data) = c("gameID","game","currentround","c13_superid","c13_satisfaction","c13_behavior","c13_payoff","c13_cumulativePayoff", "c13_cPayoffS")
names(c14_data) = c("gameID","game","currentround","c14_superid","c14_satisfaction","c14_behavior","c14_payoff","c14_cumulativePayoff", "c14_cPayoffS")
names(c15_data) = c("gameID","game","currentround","c15_superid","c15_satisfaction","c15_behavior","c15_payoff","c15_cumulativePayoff", "c15_cPayoffS")
names(c16_data) = c("gameID","game","currentround","c16_superid","c16_satisfaction","c16_behavior","c16_payoff","c16_cumulativePayoff", "c16_cPayoffS")
names(c17_data) = c("gameID","game","currentround","c17_superid","c17_satisfaction","c17_behavior","c17_payoff","c17_cumulativePayoff", "c17_cPayoffS")
names(c18_data) = c("gameID","game","currentround","c18_superid","c18_satisfaction","c18_behavior","c18_payoff","c18_cumulativePayoff", "c18_cPayoffS")
names(c19_data) = c("gameID","game","currentround","c19_superid","c19_satisfaction","c19_behavior","c19_payoff","c19_cumulativePayoff", "c19_cPayoffS")
names(c20_data) = c("gameID","game","currentround","c20_superid","c20_satisfaction","c20_behavior","c20_payoff","c20_cumulativePayoff", "c20_cPayoffS")
...
write.csv(mdata1, "mdata1_0217X.csv",quote=FALSE,row.names=FALSE) 
...
mdata1 = outcome_network_c14


mdata1$e_degree = as.numeric(apply(mdata1[,c("superid2.1","superid2.2","superid2.3","superid2.4","superid2.5","superid2.6","superid2.7","superid2.8","superid2.9","superid2.10","superid2.11","superid2.12","superid2.13","superid2.14")],1,length1))

#rate of cooperative behavior 
mdata1$rate_coop = as.numeric(apply(mdata1[,c("a1_behavior","a2_behavior","a3_behavior","a4_behavior","a5_behavior","a6_behavior","a7_behavior","a8_behavior","a9_behavior","a10_behavior","a11_behavior","a12_behavior","a13_behavior","a14_behavior")],1,mean1))
...
mdata1$prev_local_rate_coop = as.numeric(apply(mdata1[,c("a1_behavior","a2_behavior","a3_behavior","a4_behavior","a5_behavior","a6_behavior","a7_behavior","a8_behavior","a9_behavior","a10_behavior","a11_behavior","a12_behavior","a13_behavior","a14_behavior")],1,mean1))
mdata1$cur_local_rate_coop = as.numeric(apply(mdata1[,c("c1_behavior","c2_behavior","c3_behavior","c4_behavior","c5_behavior","c6_behavior","c7_behavior","c8_behavior","c9_behavior","c10_behavior","c11_behavior","c12_behavior","c13_behavior","c14_behavior")],1,mean1))
...
mdata2 = mdata1[,c("gameID","game","scoreA","scoreB","percentA","showScore","round","superid","satisfaction","behavior","e_behavior","e_payoff","cPayoffS","behaviorTime","e_behaviorTime", "payoff","cumulativePayoff","e_cumulativePayoff","n_ties","e_degree","e_satisfaction","rate_coop","rate_rich","local_gini","local_avg_wealth","local_avg_stdwealth","local_med_wealth","prev_local_rate_coop","cur_local_rate_coop","rank","rel_rank", "rel_wealth")]


colnames(mdata2)[colnames(mdata2) == "n_ties"] = "degree"
save(mdata1,file="new_mdata1_0118X.Rdata")
save(mdata2,file="new_mdata2_0118X.Rdata")
load("mdata1_0217X.Rdata") #ldata
...
write.csv(initial_data2, "initial_data2_0217X.csv",quote=FALSE,row.names=FALSE) 
mdata3 = merge(x=mdata2,y=initial_data2,all.x=TRUE,all.y=FALSE,by="superid")
write.csv(mdata3, "mdata3_0217X.csv",quote=FALSE,row.names=FALSE) #For STATA 

save(mdata3, file= "mdata3.Rdata")
