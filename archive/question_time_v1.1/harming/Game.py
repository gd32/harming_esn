...
Editied on 2023 by Hiroyasu Ando
'''
...
class Game:
    ...
    # Added 2023/05/23
    def setPlayerFinalScore(self, playerId, score, time):
        self.Players[playerId].setFinalScore(score, time)
    ...
    def writeJSON(self, folder = ""):
        ...
        for round in range(self.numRounds + 1):
            ...
            for n in graph.nodes():
                ...
                # Added 2023/05/23
                graph.nodes[n]["finalscore"] = self.Players[n].FinalScore
                graph.nodes[n]["finalscore_time"] = self.Players[n].FinalScore_time

                #print(graph.nodes[n]["finalscore"])
                #print(graph.nodes[n]["finalscore_time"])
