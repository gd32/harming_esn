...
setwd("~/Documents/Projects/harming_esn/question_time_v1.1/harming/json/")
...
save(ndata,file="~/Documents/Projects/harming_esn/question_time_v1.1/harming/node_harming.Rdata") 
save(ldata,file="~/Documents/Projects/harming_esn/question_time_v1.1/harming/link_harming.Rdata") 
