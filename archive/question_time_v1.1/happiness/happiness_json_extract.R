...
setwd("~/Documents/Projects/harming_esn/question_time_v1.1/happiness/Data/json/")
...
save(ndata,file="~/Documents/Projects/harming_esn/question_time_v1.1/happiness/node_happiness.Rdata") 
save(ldata,file="~/Documents/Projects/harming_esn/question_time_v1.1/happiness/link_happiness.Rdata") 
