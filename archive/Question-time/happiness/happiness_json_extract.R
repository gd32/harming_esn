...
setwd("~/Documents/Projects/harming_esn/Question-time/happiness/Data/json")
...
save(ndata,file="~/Documents/Projects/harming_esn/Question-time/happiness/node_happiness.Rdata") 
save(ldata,file="~/Documents/Projects/harming_esn/Question-time/happiness/link_happiness.Rdata") 
