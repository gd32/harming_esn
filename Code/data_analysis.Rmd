...
The following terms are defined in the main manuscript but are listed here for your convenience.

- *Punishment* :Justifiable harming*?  call this punishment? Costly Punishment: punishment in which harming is chosen to enhance others to change to cooperation use the local_rate_coop_lag < 0.5 and choosing punishment vs. *unjustified harming*
- Aggression
- Harming
- Peace: round with no choice of "P" among all players
- Extended? to more than 2+ rounds of peace
- Cascade: can be for any behavior
...
### Adding starting centrality measures
...
# Evaluating rewiring as the outcome
