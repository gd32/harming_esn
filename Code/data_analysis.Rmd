...
```{r}
load("~/Documents/Projects/harming_esn/Data/harming_jsons/link_1aX.Rdata")
...
# For game 1
game1_round0_edgelist = ldata %>% filter(game == 1, round == 0) %>% dplyr::select(id1, id2)
g0 = graph_from_data_frame(game1_round0_edgelist, directed = T, vertices = ndata1_r0)
pal = brewer.pal(length(unique(V(g0)$behavior_punish)), "Set1") #Red = D, Blue = C, Green = P
p0 = plot(g0, 
     layout = coords, 
     vertex.color = pal[as.numeric(as.factor(vertex_attr(g0, "behavior_coop")))])
coords = layout.auto(g0)

game1_round1_edgelist = ldata %>% filter(game == 1, round == 1) %>% dplyr::select(id1, id2)
g1 = graph_from_data_frame(game1_round1_edgelist, directed = T, vertices = ndata1_r1)
p1 = plot(g1, 
     layout = coords,
     vertex.color = pal[as.numeric(as.factor(vertex_attr(g1, "behavior_coop")))])

game1_round2_edgelist = ldata %>% filter(game == 1, round == 2) %>% dplyr::select(id1, id2)
g2 = graph_from_data_frame(game1_round2_edgelist, directed = T, vertices = ndata1_r2)
p2 = plot(g2, 
     layout = coords,
     vertex.color = pal[as.numeric(as.factor(vertex_attr(g2, "behavior_coop")))])

game1_round3_edgelist = ldata %>% filter(game == 1, round == 3) %>% dplyr::select(id1, id2)
g3 = graph_from_data_frame(game1_round3_edgelist, directed = T, vertices = ndata1_r3)
p3 = plot(g3, 
     layout = coords,
     vertex.color = pal[as.numeric(as.factor(vertex_attr(g3, "behavior_coop")))])

game1_round4_edgelist = ldata %>% filter(game == 1, round == 4) %>% dplyr::select(id1, id2)
g4 = graph_from_data_frame(game1_round4_edgelist, directed = T, vertices = ndata1_r4)
p4 = plot(g4, 
     layout = coords,
     vertex.color = pal[as.numeric(as.factor(vertex_attr(g4, "behavior_coop")))])

game1_round5_edgelist = ldata %>% filter(game == 1, round == 5) %>% dplyr::select(id1, id2)
g5 = graph_from_data_frame(game1_round5_edgelist, directed = T, vertices = ndata1_r5)
p5 = plot(g5, 
     layout = coords,
     vertex.color = pal[as.numeric(as.factor(vertex_attr(g5, "behavior_coop")))])

game1_round6_edgelist = ldata %>% filter(game == 1, round == 6) %>% dplyr::select(id1, id2)
g6 = graph_from_data_frame(game1_round6_edgelist, directed = T, vertices = ndata1_r6)
p6 = plot(g6, 
     layout = coords,
     vertex.color = pal[as.numeric(as.factor(vertex_attr(g6, "behavior_coop")))])
game1_round7_edgelist = ldata %>% filter(game == 1, round == 7) %>% dplyr::select(id1, id2)
g7 = graph_from_data_frame(game1_round7_edgelist, directed = T, vertices = ndata1_r7)
p7 = plot(g7, 
     layout = coords,
     vertex.color = pal[as.numeric(as.factor(vertex_attr(g7, "behavior_coop")))])
game1_round8_edgelist = ldata %>% filter(game == 1, round == 8) %>% dplyr::select(id1, id2)
g8 = graph_from_data_frame(game1_round8_edgelist, directed = T, vertices = ndata1_r8)
p8 = plot(g8, 
     layout = coords,
     vertex.color = pal[as.numeric(as.factor(vertex_attr(g8, "behavior_coop")))])

game1_round9_edgelist = ldata %>% filter(game == 1, round == 9) %>% dplyr::select(id1, id2)
g9 = graph_from_data_frame(game1_round9_edgelist, directed = T, vertices = ndata1_r9)
p9 = plot(g9, 
     layout = coords,
     vertex.color = pal[as.numeric(as.factor(vertex_attr(g9, "behavior_coop")))])

game1_round10_edgelist = ldata %>% filter(game == 1, round == 10) %>% dplyr::select(id1, id2)
g10 = graph_from_data_frame(game1_round10_edgelist, directed = T, vertices = ndata1_r10)

game1_round11_edgelist = ldata %>% filter(game == 1, round == 11) %>% dplyr::select(id1, id2)
g11 = graph_from_data_frame(game1_round11_edgelist, directed = T, vertices = ndata1_r11)

game1_round12_edgelist = ldata %>% filter(game == 1, round == 12) %>% dplyr::select(id1, id2)
g12 = graph_from_data_frame(game1_round12_edgelist, directed = T, vertices = ndata1_r12)

game1_round13_edgelist = ldata %>% filter(game == 1, round == 13) %>% dplyr::select(id1, id2)
g13 = graph_from_data_frame(game1_round13_edgelist, directed = T, vertices = ndata1_r13)

game1_round14_edgelist = ldata %>% filter(game == 1, round == 14) %>% dplyr::select(id1, id2)
g14 = graph_from_data_frame(game1_round14_edgelist, directed = T, vertices = ndata1_r14)

game1_round15_edgelist = ldata %>% filter(game == 1, round == 15) %>% dplyr::select(id1, id2)
g15 = graph_from_data_frame(game1_round15_edgelist, directed = T, vertices = ndata1_r15)
```

```{r}
# Creating a game1 animation
library(animation)
