...
load("/Users/gdewey/Dropbox/Active-AN22HARM-NatEE/Data/data1.Rdata")
...
# Behaviors
table(harmdata$behavior_coop) #4878 coop
table(harmdata$behavior_defect) #4336 defect
...
# Should be 10727 rows

# Create data without nulls (for mixed model regressions)
...
load(file = "~/Documents/Projects/harming_esn/Data/data1_complete.Rdata") #should be 7458 rows
```
...
save(data1_cc, file = "~/Documents/Projects/harming_esn/Data/data1_cc_final.Rdata")
```
