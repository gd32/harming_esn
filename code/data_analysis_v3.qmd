...
exp4_tp_minus_fig3_data = bind_cols(exp4data_tp_minus_count, exp4data_tp_minus_CI, exp4_tp_minus_times)[-7]
...
fig3A = fig3data %>%
  ...
  annotate("text", x = 1:3, 
           y = c(0.46, 0.61, 0.12), 
           label = c("italic(p) == 0.664", "italic(p) == 0.758", "italic(p) == 0.475"), 
           parse = T) 
fig3A
```
```{r}
...
```{r}
m2.1 = glmer(behavior_coop ~ time_pressure + factor(round) + (1|game) + (1|superid),  data = exp4data, family = binomial, nAGQ=0, control = glmerControl(optimizer = c("bobyqa"), optCtrl=list(maxfun=2e5), calc.derivs=FALSE))
...
```{r}
m2.2 = glmer(behavior_defect ~ time_pressure + factor(round) + (1|game) + (1|superid),  data = exp4data, family = binomial, nAGQ=0, control = glmerControl(optimizer = c("bobyqa"), optCtrl=list(maxfun=2e5), calc.derivs=FALSE))
...
```{r}
m3.1 = glmer(punish_type_CR ~ time_pressure + factor(round) + (1|game) + (1|superid),  data = exp4data, family = binomial, nAGQ=0, control = glmerControl(optimizer = c("bobyqa"), optCtrl=list(maxfun=2e5), calc.derivs=FALSE))
...
```
```{r}
m3.2 = glmer(punish_type_NR ~ time_pressure + factor(round) + (1|game) + (1|superid),  data = exp4data, family = binomial, nAGQ=0, control = glmerControl(optimizer = c("bobyqa"), optCtrl=list(maxfun=2e5), calc.derivs=FALSE))
...
```{r}
m3.3 = glmer(punish_type_IA ~ time_pressure + factor(round) + (1|game) + (1|superid),  data = exp4data, family = binomial, nAGQ=0, control = glmerControl(optimizer = c("bobyqa"), optCtrl=list(maxfun=2e5), calc.derivs=FALSE))
...
```
```{r}
m3.4 = glmer(punish_type_U ~ time_pressure + factor(round) + (1|game) + (1|superid),  data = exp4data, family = binomial, nAGQ=0, control = glmerControl(optimizer = c("bobyqa"), optCtrl=list(maxfun=2e5), calc.derivs=FALSE))
