...
# Experiment 2 data
load("~/Documents/Projects/harming_esn/code/exp2/tpdata_pc_v2.Rdata")
```
...
```{r}
# Load figure data
fig1data1 = read_csv("~/Documents/Projects/harming_esn/data/for_visuals/fig1data_1.csv")
fig1data2 = read_csv("~/Documents/Projects/harming_esn/data/for_visuals/fig1data_2.csv")
```
...
fig2data_1 = read_csv("~/Documents/Projects/harming_esn/data/for_visuals/fig2data_1.csv")
```
