...
load(file="node_1aX_exp4.Rdata") #ndata
load(file="link_1aX_exp4.Rdata") #ldata
...
load("~/Documents/Projects/harming_esn/Data/exp4/node_1aX_exp4.Rdata") #ndata
...
dim(ndata1[ndata1$round==0,]) # 49 individuals
dim(ndata1) # 784individual rounds
