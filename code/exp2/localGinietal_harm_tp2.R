rm(list = ls())
getwd()
setwd("~/Documents/Projects/harming_esn/data/exp2/")
load(file="node_1aX_tp2.Rdata") 
load(file="link_1aX_tp2.Rdata") 
...
save(ldata4,file="ldata4_tp2.Rdata")
load("ldata4_tp2.Rdata") #ldata
...
save(ndata1,file="ndata1_tp2.Rdata") #This is used for the individual-level analysis. 
load("ndata1_tp2.Rdata") #ndata1 

dim(ndata1[ndata1$round==0,]) #247 individuals (up to game 20)
dim(ndata1)
...
write.csv(mdata1, "mdata1_tp2.csv", quote=FALSE, row.names=FALSE) 
...
#rate of defection
mdata1$rate_defect = as.numeric(apply(mdata1[,c("a1_behavior_coop","a2_behavior_coop","a3_behavior_coop","a4_behavior_coop","a5_behavior_coop","a6_behavior_coop","a7_behavior_coop","a8_behavior_coop","a9_behavior_coop","a10_behavior_coop","a11_behavior_coop","a12_behavior_coop","a13_behavior_coop","a14_behavior_coop")],1,mean1))
mdata1$rate_defect[is.nan(mdata1$rate_defect)] = NA

#rate of attack/punish
mdata1$rate_punish = as.numeric(apply(mdata1[,c("a1_behavior_coop","a2_behavior_coop","a3_behavior_coop","a4_behavior_coop","a5_behavior_coop","a6_behavior_coop","a7_behavior_coop","a8_behavior_coop","a9_behavior_coop","a10_behavior_coop","a11_behavior_coop","a12_behavior_coop","a13_behavior_coop","a14_behavior_coop")],1,mean1))
...
save(mdata1,file="tp2_mdata1.Rdata")
save(mdata2,file="tp2_mdata2.Rdata")
...
write.csv(initial_data2, "initial_data2_tp.csv",quote=FALSE,row.names=FALSE) 
mdata3 = merge(x=mdata2,y=initial_data2,all.x=TRUE,all.y=FALSE,by="superid")
write.csv(as.matrix(mdata3), "mdata3_tp2.csv",quote=FALSE,row.names=FALSE) #For STATA 

save(mdata3, file= "mdata3_tp2.Rdata")
