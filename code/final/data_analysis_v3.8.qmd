...
#### Evaluating the effect of wealth visibility on inequality aversion punishment (Table S10, S11)
...
### Testing the reciprocal effect of defection for defection decisions (Table S12)
...
```{r}
## Regression for punishment and rewiring, Exp. 2 (TP+) ------------------------
model_e2_rwr_plus = glmer(rewired ~ behavior_punish + round + (1|game) + (1|superid), 
              data = exp2data %>% filter(round > 0, 
                                              behavior %in% c('C', 'D', 'P'),
                                              time_pressure == 'Plus'),
              family = 'binomial', nAGQ=0, 
