...
```{r}
## Experiment 1
exp1data = read_csv("~/Documents/Projects/harming_esn/data/final/exp1data_rev1.csv",
                    show_col_types = FALSE)

## Experiment 2
exp2data = read_csv("~/Documents/Projects/harming_esn/data/final/exp2data_rev1.csv", 
                    show_col_types = FALSE)
```
...
###### Regression analysis for the effect of low initial wealth allocation on decision time
...
##### Evaluating the effect of choosing punishment on rewiring (Supplemental Table S13)
...
summary(glmer(rewired ~ behavior_punish + round + (1|game) + (1|superid), 
...
### Sensitivity analysis for the effect of wealth visibility on inequality aversion - restrict Exp. 1 data to invisible wealth only
