...
### Main
```{r}
(exp1_fig1_A + exp1_fig1_C)/ (exp1_fig1_B + exp1_fig1_D)
...
fig3A = fig3data %>%
  ...
  geom_bar_pattern(position = "dodge", stat = "identity", alpha = 0.5, 
                   pattern_density = 0.25, pattern_fill = "black", 
  ...
  scale_color_manual(values = c("dodgerblue4", "darkorange3", "#574AE2"), guide = "none") +
...
```{r}
m4_3 = lmer(behaviorTime_sec_adj ~ punish_type_U + punish_type_CR + punish_type_NR + round + (1|game) + (1|superid), data = exp1data %>%
