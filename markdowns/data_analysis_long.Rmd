...
```{r}
## Two sample t-test for difference in DT distributions by behavior category
...
t.test(times_punish, times_coop)
t.test(times_punish, times_defect)
...
data1_pc %>% 
  ...
  scale_x_log10(limits = c(1, 110),breaks = c(1, 10, 100)) +
  scale_y_continuous(limits = c(0, 1.3)) +
  scale_color_manual(labels = c("IA", "RP", "UE", "Other"),
